...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 22 15:48:47 2024
...
foldername = "./data/deepymod/burgers/NN_64"
...
foldername_2 = "./data/deepymod/burgers/NN_32"
#shutil.rmtree(foldername)
...
foldername_3 = "./data/deepymod/burgers/NN_16"
#shutil.rmtree(foldername)
...
foldername_4 = "./data/deepymod/burgers/NN_8"
#shutil.rmtree(foldername)
...
sparsity_scheduler_4 = Periodic(periodicity=100, initial_iteration=2000)

estimator_4 = STRidge(tol=0.05)
