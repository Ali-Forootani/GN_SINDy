...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 22 10:31:07 2023
...
Discovering Allen-Cahn equation with DeePyMOD
...
def create_data():
    ...
    t = 1*data["tt"].flatten()[0:201, None]
    x = 1*data["x"].flatten()[:, None]
...
foldername = "./data/deepymod/Allen_Cahn_random/"
...
plt.savefig(foldername +
     "AC" + "coefficients" + "random_sampling" + f'{num_of_samples}'  
