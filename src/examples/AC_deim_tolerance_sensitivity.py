...
Allen-Cahn equation dicovery with GNSINDy algorithm under analysis of

Different precision value for Q-DEIM algorithm
...
def create_data_1():
    data = loadmat( root_dir + "/data/AC.mat")
...
#sparsity_scheduler_1 = Periodic(periodicity=200, initial_iteration=1000)
...
#sparsity_scheduler_2 = Periodic(periodicity=200, initial_iteration=1000)
...
#sparsity_scheduler_3 = Periodic(periodicity=200, initial_iteration=1000)
...
dataset_4 = Dataset(
    ...
    preprocess_kwargs={
        ...
        "normalize_data": False,},
    subsampler=Subsample_random,
    subsampler_kwargs={"number_of_samples": num_of_samples_4},
    device=device,)
...
sparsity_scheduler_4 = TrainTestPeriodic(periodicity=200, patience=1000, delta=1e-5)

sparsity_scheduler_4 = Periodic(periodicity=100, initial_iteration=1000)
