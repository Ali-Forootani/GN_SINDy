...
def create_data():
    ...
    ldeim_instance = LDEIM(Exact, 5, t_o, x_o, tolerance = -1, num_basis = 5, n_patches=4,
    overlap=2,
    k_per_patch=3 )
    S_s, T_s, U_s = ldeim_instance.execute()
...
plt.savefig(foldername +
     "Burgers" + "coefficients" + "LDEIM_sampling" + f'{num_of_samples}'  
...
plt.savefig(foldername +
     "Burgers" + "_LDEIM_schematic_" + f'{num_of_samples_2}'  
     +"_poly_order_ " + f'{poly_order}'
     +"_diff_order_ " + f'{diff_order}'
     +
     ".png", bbox_inches='tight',
...
plt.savefig(foldername +
     "Burgers" + "_coeff_iterations_LDEIM_" + f'{num_of_samples}'  
     +"_poly_order_ " + f'{poly_order}'
     +"_diff_order_ " + f'{diff_order}'
     +
     ".png", bbox_inches='tight',
